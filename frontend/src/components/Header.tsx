                            ...
                            <div className="flex space-x-4 items-center">
                                ...
                                {!isLoading && user && (
                                    <>
                                        ...
                                        <Link to="/profile" className={getLinkClasses('/profile')}>Profile</Link> {/* Add Profile Link (Desktop) */}
                                    </>
                                )}
                            </div>
                        </div>
                    ...
                    <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                        {isLoading ? (
                            ...
                            <div className="flex items-center space-x-3">
                                ...
                                <button onClick={handleLogout} className="bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-semibold py-1 px-2 rounded transition duration-150 ease-in-out">
                                    Logout
                                </button>
                            </div>
                        ) : (
                 ...
                 <div className="space-y-1 px-2 pt-2 pb-3">
                    ...
                    {!isLoading && user && (
                        <>
                            ...
                            <Link to="/profile" className={getLinkClasses('/profile', true)} onClick={() => setIsMobileMenuOpen(false)}>Profile</Link> {/* Add Profile Link (Mobile) */}
                        </>
                    )}
                    {isLoading ? (
