...
const LoginPage: FC = () => {
    ...
    const registrationSuccessMessage = location.state?.message as string | undefined;
    ...
    // Use Spinner when AuthContext is loading
    if (isAuthLoading) {
        return (
            <div className="flex justify-center items-center min-h-screen">
                <Spinner size="lg" /> {/* Use Spinner here */}
            </div>
        );
    }
        ...
        <div className="flex items-center justify-center min-h-screen bg-gray-100 px-4">
            <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-md">
                ...
                {registrationSuccessMessage && !error && (
                    <Alert message={registrationSuccessMessage} type="success" title="Success!" />
                )}
                ...
                <div>
                    ...
                    >
                        <svg className="w-5 h-5 mr-2 -ml-1" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="google" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512"><path fill="currentColor" d="M488 261.8C488 403.3 381.5 512 244 512 109.8 512 0 402.2 0 261.8 0 120.5 109.8 11.8 244 11.8c71.9 0 133.6 29.6 178.9 77.5l-68.8 67.2c-23.5-22.2-54.8-35.8-90.1-35.8-67.3 0-121.6 54.4-121.6 121.6s54.3 121.6 121.6 121.6c78.6 0 104.9-61.2 108.6-93.6H244v-86h244z"></path></svg>
                        Login with Google
                    </button>
                </div>
